...
public class HeadcrumbsHandler {
	...
	public static void addTooltips(String[] UsernamesAndTooltips) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException{
		Map<String, String> HeadcrumbsExtractedMap = Util.getField(HeadcrumbsMap, HeadcrumbsMapField, null, Map.class);
